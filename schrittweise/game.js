// game.js — XP, Levels und Medaillen für Schrittweise. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'zaehler', name: 'Schrittzähler' },
  { xp: 25, key: 'schleifen', name: 'Schleifenkenner' },
  { xp: 90, key: 'leser', name: 'Programmleser' },
  { xp: 220, key: 'schreiber', name: 'Codeschreiber' },
  { xp: 500, key: 'meister', name: 'Algorithmus-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Befehl', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Schrittweise-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Schleifenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Code-Schatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-z1', icon: 'target', threshold: (s) => cleanRuns(s, 'a') >= 1, name: 'Grundanspruch Zyklus 1', desc: 'Stufe a ohne Fehler geschafft.' },
  { key: 'ga-z2', icon: 'target', threshold: (s) => cleanRuns(s, 'f') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe f ohne Fehler geschafft.' },
  { key: 'ga-z3', icon: 'target', threshold: (s) => cleanRuns(s, 'h') >= 1, name: 'Grundanspruch Zyklus 3', desc: 'Stufe h ohne Fehler geschafft.' },
