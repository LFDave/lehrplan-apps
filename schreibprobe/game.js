// game.js — XP, Levels und Medaillen für Schreibprobe. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Schreibstarter' },
  { xp: 25, key: 'pruefer', name: 'Wortprüfer' },
  { xp: 90, key: 'kenner', name: 'Regelkenner' },
  { xp: 220, key: 'profi', name: 'Schreibprofi' },
  { xp: 500, key: 'meister', name: 'Schreibmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erste Probe', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Schreibprobe-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Regelblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Wortschatz-Truhe', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-z1', icon: 'target', threshold: (s) => cleanRuns(s, 'a') >= 1, name: 'Grundanspruch Zyklus 1', desc: 'Stufe a ohne Fehler geschafft.' },
  { key: 'ga-z2', icon: 'target', threshold: (s) => cleanRuns(s, 'd') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe d ohne Fehler geschafft.' },
