...
export const POOLS = {
  ...
  'c-schreibung': [
    ...
    ['ieSchreibung', 'mc', 'Welche Schreibung stimmt?', 'Liebe', ['Libe']],
    ['ieSchreibung', 'typed', 'Schreibe richtig: Spil', 'Spiel'],
    ['ieSchreibung', 'typed', 'Schreibe richtig: Zil', 'Ziel'],
    ['ieSchreibung', 'typed', 'Schreibe richtig: Papir', 'Papier'],
    ...
    ['aeSchreibung', 'mc', 'Warum schreibt man «Räder» mit ä?', 'wegen «Rad»', ['wegen «reden»', 'ohne Grund']],
    ['aeSchreibung', 'typed', 'Schreibe richtig: Negel', 'Nägel'],
  ],
  'c-kommas': [
    ...
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Ich packe Hose, Pullover und Schuhe ein.', ['Ich packe Hose Pullover und Schuhe ein.']],
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Wir sehen Kühe, Pferde und Schafe.', ['Wir sehen Kühe Pferde und Schafe.']],
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Anna malt mit Rot, Blau und Grün.', ['Anna malt mit Rot Blau und Grün.']],
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Im Garten wachsen Rüebli, Salat und Bohnen.', ['Im Garten wachsen Rüebli Salat und Bohnen.']],
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Zum Zmorge gibt es Brot, Butter und Honig.', ['Zum Zmorge gibt es Brot Butter und Honig.']],
    ['kommaAufzaehlung', 'mc', 'Wo stehen die Kommas richtig?', 'Auf dem Pult liegen Stifte, Hefte und Bücher.', ['Auf dem Pult liegen Stifte Hefte und Bücher.']],
  ],
  d: [
