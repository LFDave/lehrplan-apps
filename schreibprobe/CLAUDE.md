...
- **Guiding principle: one app = one Lehrplan 21 competency (D.4.F.1);
...
- Storage key `schreibprobe.progress`; Kompass links here via
  `PRACTICE_APPS['D.4.F.1']` in `lehrplan-kompass/data.js`.
