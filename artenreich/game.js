// game.js — XP, Levels und Medaillen für Artenreich. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Arten-Starter' },
  { xp: 25, key: 'sammler', name: 'Merkmalsammler' },
  { xp: 90, key: 'kenner', name: 'Vogelkenner' },
  { xp: 220, key: 'profi', name: 'Ordnungs-Profi' },
  { xp: 500, key: 'meister', name: 'Arten-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Merkmal', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Artenreich-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Artenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Natur-Schatz', desc: '800 Aufgaben gelöst.' },
