...
import { CYCLES, subjectsForCycle, subjectById, areaCompetenciesForCycle, competencyCount, PRACTICE_APPS } from './data.js?v=5';
import { STRINGS, t } from './strings.js?v=5';
