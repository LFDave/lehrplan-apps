...
import { CYCLES, subjectsForCycle, subjectById, areaCompetenciesForCycle, competencyCount, PRACTICE_APPS } from './data.js?v=8';
import { STRINGS, t } from './strings.js?v=8';
