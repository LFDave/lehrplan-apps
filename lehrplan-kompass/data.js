...
export const PRACTICE_APPS = {
  ...
  'D.4.F.1': { name: 'Schreibprobe', href: '../schreibprobe/' },
  'D.5.D.1': { name: 'Wortbau', href: '../wortbau/' },
  'D.5.E.1': { name: 'Buchstabenleiter', href: '../buchstabenleiter/' },
  'FS1F.5.B.1': { name: 'Motschatz', href: '../motschatz/' },
  'FS1F.5.D.1': { name: 'Motbau', href: '../motbau/' },
  'FS1F.5.E.1': { name: 'Ortho', href: '../ortho/' },
  'FS2E.5.B.1': { name: 'Wordschatz', href: '../wordschatz/' },
  'FS2E.5.D.1': { name: 'Wordbau', href: '../wordbau/' },
  'FS2E.5.E.1': { name: 'Spellwerk', href: '../spellwerk/' },
  'NMG.1.4': { name: 'Körperatlas', href: '../koerperatlas/' },
  'NMG.2.4': { name: 'Artenreich', href: '../artenreich/' },
  'NMG.4.4': { name: 'Wetterwarte', href: '../wetterwarte/' },
  'NMG.4.5': { name: 'Sternwarte', href: '../sternwarte/' },
  'NMG.8.5': { name: 'Nordpfeil', href: '../nordpfeil/' },
