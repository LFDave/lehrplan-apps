// game.js — XP, Levels und Medaillen für Zahlenwissen. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Zahlenlehrling' },
  { xp: 25, key: 'kenner', name: 'Zahlenkenner' },
  { xp: 90, key: 'profi', name: 'Zahlenprofi' },
  { xp: 220, key: 'meister', name: 'Zahlenmeister' },
  { xp: 500, key: 'weise', name: 'Zahlenweise' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erste Seite', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Zahlenwissen-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Wissensblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Wissensschatz', desc: '800 Aufgaben gelöst.' },
