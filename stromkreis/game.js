// game.js — XP, Levels und Medaillen für Stromkreis. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Strom-Starter' },
  { xp: 25, key: 'kenner', name: 'Schaltungskenner' },
  { xp: 90, key: 'rechner', name: 'Ohm-Rechner' },
  { xp: 220, key: 'profi', name: 'Knoten-Profi' },
  { xp: 500, key: 'meister', name: 'Elektro-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Lämpchen', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Stromkreis-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Ampere-Blitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Volt-Schatz', desc: '800 Aufgaben gelöst.' },
