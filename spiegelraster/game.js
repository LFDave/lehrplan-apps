// game.js — XP, Levels und Medaillen für Spiegelraster. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Rasterstarter' },
  { xp: 25, key: 'spiegellehrling', name: 'Spiegellehrling' },
  { xp: 90, key: 'drehkuenstler', name: 'Drehkünstler' },
  { xp: 220, key: 'musterprofi', name: 'Musterprofi' },
  { xp: 500, key: 'spiegelmeister', name: 'Spiegelmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Spiegelbild', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Spiegelraster-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Drehblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Musterschatz', desc: '800 Aufgaben gelöst.' },
