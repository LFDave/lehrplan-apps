// game.js — XP, Levels und Medaillen für Spellwerk. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Spelling-Starter' },
  { xp: 25, key: 'schreiber', name: 'Wortschreiber' },
  { xp: 90, key: 'kenner', name: 'Formenkenner' },
  { xp: 220, key: 'profi', name: 'Schreibprofi' },
  { xp: 500, key: 'meister', name: 'Spelling-Meister' },
];
...
export const MEDALS = [
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Spellwerk-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Buchstabenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Wörter-Schatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-z2', icon: 'target', threshold: (s) => cleanRuns(s, 'b') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe b ohne Fehler geschafft.' },
  { key: 'ga-z3', icon: 'target', threshold: (s) => cleanRuns(s, 'c') >= 1, name: 'Grundanspruch Zyklus 3', desc: 'Stufe c ohne Fehler geschafft.' },
