...
- **Guiding principle: one app = one Lehrplan 21 competency (FS2E.5.B.1);
...
- Storage key `wordschatz.progress`; Kompass links here via
  `PRACTICE_APPS['FS2E.5.B.1']` in `lehrplan-kompass/data.js`.
