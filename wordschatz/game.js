// game.js — XP, Levels und Medaillen für Wordschatz. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'beginner', name: 'Beginner' },
  { xp: 25, key: 'collector', name: 'Word-Sammler' },
  { xp: 90, key: 'speaker', name: 'Speaker' },
  { xp: 220, key: 'kenner', name: 'Word-Kenner' },
  { xp: 500, key: 'master', name: 'Word-Master' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'First Word', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Wordschatz-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Vocabulary-Blitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Treasure of Words', desc: '800 Aufgaben gelöst.' },
