// game.js — XP, Levels und Medaillen für Rechnerraum. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Geräte-Starter' },
  { xp: 25, key: 'kenner', name: 'Ordnerkenner' },
  { xp: 90, key: 'speicher', name: 'Speicherkenner' },
  { xp: 220, key: 'profi', name: 'Netzwerk-Profi' },
  { xp: 500, key: 'meister', name: 'System-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Klick', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Rechnerraum-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Systemblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Daten-Schatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-c', icon: 'target', threshold: (s) => cleanRuns(s, 'c') >= 1, name: 'Grundanspruch Zyklus 1', desc: 'Stufe c ohne Fehler geschafft.' },
  { key: 'ga-h', icon: 'target', threshold: (s) => cleanRuns(s, 'h') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe h ohne Fehler geschafft.' },
