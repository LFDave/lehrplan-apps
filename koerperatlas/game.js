// game.js — XP, Levels und Medaillen für Körperatlas. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Körper-Starter' },
  { xp: 25, key: 'kenner', name: 'Knochenkenner' },
  { xp: 90, key: 'forscher', name: 'Organforscher' },
  { xp: 220, key: 'profi', name: 'Kreislauf-Profi' },
  { xp: 500, key: 'meister', name: 'Körper-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Herzschlag', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Körperatlas-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Organblitz', desc: '200 Aufgaben gelöst.' },
