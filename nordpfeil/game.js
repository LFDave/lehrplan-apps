// game.js — XP, Levels und Medaillen für Nordpfeil. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'wegfinder', name: 'Wegfinder' },
  { xp: 25, key: 'kartenleser', name: 'Kartenleser' },
  { xp: 90, key: 'spurensucher', name: 'Spurensucher' },
  { xp: 220, key: 'ortskundig', name: 'Ortskundiger' },
  { xp: 500, key: 'meister', name: 'Orientierungsmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Wegweiser', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Nordpfeil-Legende', desc: '55 Runden abgeschlossen.' },
