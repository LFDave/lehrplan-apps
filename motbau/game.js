// game.js — XP, Levels und Medaillen für Motbau. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Satzstarter' },
  { xp: 25, key: 'sammler', name: 'Formensammler' },
  { xp: 90, key: 'bauer', name: 'Verbenbauer' },
  { xp: 220, key: 'profi', name: 'Satzprofi' },
  { xp: 500, key: 'meister', name: 'Grammatik-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Baustein', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Motbau-Legende', desc: '55 Runden abgeschlossen.' },
  ...
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Verben-Schatz', desc: '800 Aufgaben gelöst.' },
