...
import { STUFEN, COMPETENCY, stufeById, nextStufe, cycleLabel } from './data.js?v=9';
import { genRound } from './gen.js?v=9';
import { roundXp, levelFor, nextLevel, earnedMedals, suggestsNextStufe, MEDALS } from './game.js?v=9';
import { t } from './strings.js?v=9';
