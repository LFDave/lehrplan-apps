...
export const STRINGS = {
  de: {
    'app.title': 'Wordbau',
    'app.tagline': 'Englische Sätze bauen, Stufe für Stufe.',
    'app.source': 'Setzt die Kompetenz FS2E.5.D.1 des Lehrplans 21 um (Kanton Bern, Stand 01.08.2022). Die Stufen a bis d sind die offiziellen Kompetenzstufen. Sprechen und freies Schreiben sind als Erkennen und Einsetzen von Formen umgesetzt.',
