// game.js — XP, Levels und Medaillen für Wordbau. Reine Funktionen
...
export const LEVELS = [
  ...
  { xp: 90, key: 'bauer', name: 'Wortbauer' },
...
export const MEDALS = [
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Wordbau-Legende', desc: '55 Runden abgeschlossen.' },
  ...
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Sätze-Schatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-z2', icon: 'target', threshold: (s) => cleanRuns(s, 'a') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe a ohne Fehler geschafft.' },
