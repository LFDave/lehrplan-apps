// game.js — XP, Levels und Medaillen für Motschatz. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'debutant', name: 'Débutant' },
  { xp: 25, key: 'sammler', name: 'Wortsammler' },
  { xp: 90, key: 'parleur', name: 'Parleur' },
  { xp: 220, key: 'kenner', name: 'Mot-Kenner' },
  { xp: 500, key: 'tresor', name: 'Trésor vivant' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Premier mot', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Motschatz-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Vocabulaire-Blitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Trésor des mots', desc: '800 Aufgaben gelöst.' },
