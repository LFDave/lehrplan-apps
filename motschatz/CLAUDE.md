...
- **Guiding principle: one app = one Lehrplan 21 competency (FS1F.5.B.1);
...
- Storage key `motschatz.progress`; Kompass links here via
  `PRACTICE_APPS['FS1F.5.B.1']` in `lehrplan-kompass/data.js`.
