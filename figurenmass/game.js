// game.js — XP, Levels und Medaillen für Figurenmass. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Formenzähler' },
  { xp: 25, key: 'umfangkenner', name: 'Umfangkenner' },
  { xp: 90, key: 'flaechenprofi', name: 'Flächenprofi' },
  { xp: 220, key: 'volumenmeister', name: 'Volumenmeister' },
  { xp: 500, key: 'geometrieweise', name: 'Geometrieweise' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Quadrat', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Figurenmass-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Flächenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Formenschatz', desc: '800 Aufgaben gelöst.' },
