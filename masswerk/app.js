// app.js — Masswerk. Ansichten: Übersicht (Stufenleiter), Übung,
...
function renderHome() {
  ...
  app.innerHTML = `
    ...
    <section class="stufen-section">
      ...
      <p class="storage-note">${t('home.note')}</p>
    </section>
...
function renderTask() {
  ...
  const showsEquals = isTyped && !task.expr.includes('?') && !task.expr.startsWith('Das ') && !task.expr.startsWith('Die ');
