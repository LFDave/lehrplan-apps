...
- **Guiding principle: one app = one Lehrplan 21 competency (D.5.D.1);
...
- Storage key `wortbau.progress`; Kompass links here via
  `PRACTICE_APPS['D.5.D.1']` in `lehrplan-kompass/data.js`.
