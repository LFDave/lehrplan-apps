// game.js — XP, Levels und Medaillen für Wortbau. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'sammler', name: 'Wörtersammler' },
  { xp: 25, key: 'bestimmer', name: 'Wortbestimmer' },
  { xp: 90, key: 'former', name: 'Formenkenner' },
  { xp: 220, key: 'bauer', name: 'Satzbauer' },
  { xp: 500, key: 'meister', name: 'Grammatikmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Wort', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Wortbau-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Formenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Wörterschatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-z1', icon: 'target', threshold: (s) => cleanRuns(s, 'a') >= 1, name: 'Grundanspruch Zyklus 1', desc: 'Stufe a ohne Fehler geschafft.' },
  { key: 'ga-z2', icon: 'target', threshold: (s) => cleanRuns(s, 'c') >= 1, name: 'Grundanspruch Zyklus 2', desc: 'Stufe c ohne Fehler geschafft.' },
  { key: 'ga-z3', icon: 'target', threshold: (s) => cleanRuns(s, 'e') >= 1, name: 'Grundanspruch Zyklus 3', desc: 'Stufe e ohne Fehler geschafft.' },
