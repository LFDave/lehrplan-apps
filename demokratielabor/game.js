// game.js — XP, Levels und Medaillen für Demokratielabor. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Demokratie-Starter' },
  { xp: 25, key: 'kenner', name: 'Gewaltenkenner' },
  { xp: 90, key: 'buerger', name: 'Abstimmungs-Profi' },
  { xp: 220, key: 'profi', name: 'Debatten-Profi' },
  { xp: 500, key: 'meister', name: 'Demokratie-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erste Stimme', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Demokratielabor-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Staatskunde-Blitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Rechte-Schatz', desc: '800 Aufgaben gelöst.' },
  { key: 'ga-c', icon: 'target', threshold: (s) => cleanRuns(s, 'c') >= 1, name: 'Grundanspruch Zyklus 3', desc: 'Stufe c ohne Fehler geschafft.' },
