// e2e.test.mjs — Playwright end-to-end tests for Demokratielabor.
//
// Run:
//   cd demokratielabor/tests && npm install && node e2e.test.mjs
//
...
// Antwort). Staatskunde-Fakten, von Hand nachgeprüft.
const QA = {
  "Wo entstand die Demokratie der Antike?": "im alten Griechenland (Athen)",
  "Demokratie heisst wörtlich ...?": "Herrschaft des Volkes",
  "In einer Diktatur ...?": "herrscht eine Person oder Gruppe ohne freie Wahlen",
  "In einer Monarchie steht an der Spitze ...?": "ein König oder eine Königin",
  "Volkssouveränität bedeutet ...?": "die höchste Macht liegt beim Volk",
  "Wozu begrenzt eine Verfassung die Macht?": "damit niemand allein zu viel Macht hat",
  "In welchem Jahr entstand der Schweizer Bundesstaat?": "1848",
  "Das Bürgerrecht gibt dir in der Demokratie ...?": "Rechte wie Wählen und Abstimmen",
  "Freie und geheime Wahlen gehören zu ...?": "einer Demokratie",
  "Wer macht auf Bundesebene die Gesetze?": "das Parlament (National- und Ständerat)",
  "Wer regiert auf Bundesebene?": "der Bundesrat",
  "Wer spricht Recht?": "die Gerichte",
  "Wie viele Mitglieder hat der Bundesrat?": "7",
  "Wie viele Mitglieder hat der Nationalrat?": "200",
  "Wie viele Mitglieder hat der Ständerat?": "46",
  "Die drei Gewalten heissen ...?": "Legislative, Exekutive, Judikative",
  "Die drei Staatsebenen der Schweiz sind ...?": "Gemeinde, Kanton, Bund",
  "Warum sind die Gewalten getrennt?": "damit sich Macht gegenseitig kontrolliert",
  "Die Verfassung ist ...?": "das oberste Regelwerk des Staates",
  "Mit einer Volksinitiative kann das Volk ...?": "eine Änderung der Verfassung vorschlagen",
  "Mit einem Referendum kann das Volk ...?": "über ein beschlossenes Gesetz abstimmen",
  "Wie viele Unterschriften braucht eine Volksinitiative?": "100000",
  "Wie viele Unterschriften braucht ein fakultatives Referendum?": "50000",
  "Föderalismus heisst ...?": "die Kantone haben eigene Aufgaben und Rechte",
  "Ab welchem Alter darf man national abstimmen?": "18",
  "Seit welchem Jahr gilt das Frauenstimmrecht auf Bundesebene?": "1971",
  "Parteien sind ...?": "Gruppen mit ähnlichen politischen Zielen",
  "Direkte Demokratie bedeutet ...?": "das Volk stimmt selbst über Sachfragen ab",
  "Zu den Pflichten in der Demokratie gehört ...?": "Gesetze und Regeln einhalten",
  "Was ist ein Argument?": "eine Begründung für eine Meinung",
  "Eine faire Debatte braucht ...?": "zuhören und ausreden lassen",
  "Pro- und Kontra-Punkte sammeln hilft ...?": "eine eigene Position zu begründen",
  "Verlässliche Informationen kommen ...?": "aus mehreren geprüften Quellen",
  "Ein Kompromiss ist ...?": "eine Lösung, die beide Seiten tragen können",
  "Jemand ist anderer Meinung als du. Was gilt?": "respektvoll bleiben und Argumente austauschen",
  "Eine gute Stellungnahme enthält ...?": "eine klare Meinung mit Begründungen",
  "Warum hören Politikerinnen und Politiker Betroffene an?": "um verschiedene Sichtweisen zu kennen",
};
...
/* ── Generator sanity against the oracle (seeded) ─────────────────── */
{
  ...
  for (const stufe of STUFEN) {
    const rng = mulberry32(73 + stufe.id.split("").reduce((n, ch, i) => n + ch.charCodeAt(0) * (i + 1), 0));
    for (let r = 0; r < 50; r++) {
...
check("home: title renders", (await page.textContent("h1")).trim() === "Demokratielabor");
check("home: all Stufen with GA badges",
  await page.locator(".stufe").count() === 4 && await page.locator(".ga-badge").count() === 1);
check("home: competency code visible", (await page.textContent('[data-stufe="c"]')).includes("RZG.8.1.c"));
check("home: Merkblatt link Stufe b",
  await page.locator('.merkblatt-link[href="../merkheft/gewaltenteilung.html"]').count() === 1);
