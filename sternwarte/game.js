// game.js — XP, Levels und Medaillen für Sternwarte. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'gucker', name: 'Sternengucker' },
  { xp: 25, key: 'mond', name: 'Mondkenner' },
  { xp: 90, key: 'planeten', name: 'Planetenkenner' },
  { xp: 220, key: 'forscher', name: 'Weltraumforscher' },
  { xp: 500, key: 'meister', name: 'Sternenmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Stern', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Sternwarte-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Planetenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Sternenschatz', desc: '800 Aufgaben gelöst.' },
