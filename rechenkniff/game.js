// game.js — XP, Levels und Medaillen für Rechenkniff. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Rechenlehrling' },
  { xp: 25, key: 'umformer', name: 'Umformer' },
  { xp: 90, key: 'kniffkenner', name: 'Kniffkenner' },
  { xp: 220, key: 'rechenfuchs', name: 'Rechenfuchs' },
  { xp: 500, key: 'kniffmeister', name: 'Kniffmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Kniff', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Rechenkniff-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Blitzumformer', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Kniffschatz', desc: '800 Aufgaben gelöst.' },
