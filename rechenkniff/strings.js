...
export const STRINGS = {
  de: {
    'app.title': 'Rechenkniff',
    'app.tagline': 'Zerlegen, umformen und mit Rechengesetzen tricksen.',
    'app.source': 'Setzt die Kompetenz MA.1.A.4 des Lehrplans 21 um (Kanton Bern). Die Stufen a bis l sind die offiziellen Kompetenzstufen.',
