// e2e.test.mjs — Playwright end-to-end tests for Ortho.
//
// Run:
//   cd ortho/tests && npm install && node e2e.test.mjs
//
...
const QA = {
  "Welches Zeichen fehlt am Ende: Comment ça va": "?",
  "Welches Zeichen fehlt am Ende: Je joue au foot": ".",
  "Was fehlt in «Jai neuf ans»?": "der Apostroph: J'ai",
  "Wie beginnt ein Satz?": "mit einem Grossbuchstaben",
  "«ich habe» auf Französisch:": "j'ai",
  "«das ist» auf Französisch:": "c'est",
  "«es gibt» auf Französisch:": "il y a",
  "«ich bin» auf Französisch:": "je suis",
  "«wir sind» auf Französisch:": "nous sommes",
  "«ich heisse» auf Französisch:": "je m'appelle",
  "Richtig geschrieben ist ...? (die Schule)": "l'école",
  "Richtig geschrieben ist ...? (der Junge)": "le garçon",
  "Richtig geschrieben ist ...? (danke)": "merci",
  "Richtig geschrieben ist ...? (Guten Tag)": "bonjour",
  "Ergänze den fehlenden Buchstaben: la ma·son (das Haus)": "i",
  "Ergänze den fehlenden Buchstaben: m·rci (danke)": "e",
  "Ergänze den fehlenden Buchstaben: bonj·ur (Guten Tag)": "o",
  "Ergänze den fehlenden Buchstaben: le ch·en (der Hund)": "i",
  "Welches Wort ist falsch geschrieben? «Je swi content.»": "swi",
  "Welches Wort ist falsch geschrieben? «La mason est grande.»": "mason",
  "Welches Wort ist falsch geschrieben? «Nous somes amis.»": "somes",
  "Welches Wort ist falsch geschrieben? «J'ai nef ans.»": "nef",
  "Welches Wort ist falsch geschrieben? «Merci bocoup.»": "bocoup",
  "père oder pére (der Vater)?": "père",
  "mère oder mére (die Mutter)?": "mère",
  "école oder ècole (die Schule)?": "école",
  "très oder trés (sehr)?": "très",
  "Schreibe das ganze Wort: beauc… (viel)": "beaucoup",
  "Schreibe das ganze Wort: aujourd… (heute)": "aujourd'hui",
};
...
/* ── Generator sanity against the oracle (seeded) ─────────────────── */
{
  ...
  for (const stufe of STUFEN) {
    const rng = mulberry32(67 + stufe.id.charCodeAt(0));
    for (let r = 0; r < 50; r++) {
...
check("home: title renders", (await page.textContent("h1")).trim() === "Ortho");
check("home: all Stufen with GA badges",
  await page.locator(".stufe").count() === 4 && await page.locator(".ga-badge").count() === 2);
check("home: competency code visible", (await page.textContent('[data-stufe="b"]')).includes("FS1F.5.E.1.b"));
