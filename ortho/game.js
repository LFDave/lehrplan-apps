// game.js — XP, Levels und Medaillen für Ortho. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Buchstaben-Starter' },
  { xp: 25, key: 'schreiber', name: 'Wortschreiber' },
  { xp: 90, key: 'kenner', name: 'Accent-Kenner' },
  { xp: 220, key: 'profi', name: 'Schreibprofi' },
  { xp: 500, key: 'meister', name: 'Ortho-Meister' },
];
...
export const MEDALS = [
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Ortho-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Schreibblitz', desc: '200 Aufgaben gelöst.' },
