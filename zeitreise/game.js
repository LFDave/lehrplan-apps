// game.js — XP, Levels und Medaillen für Zeitreise. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'zeitling', name: 'Zeitling' },
  { xp: 25, key: 'kalender', name: 'Kalenderkenner' },
  { xp: 90, key: 'chronist', name: 'Chronist' },
  { xp: 220, key: 'historiker', name: 'Zeitforscher' },
  { xp: 500, key: 'meister', name: 'Zeitmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Schritt in die Zeit', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Zeitreise-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Epochenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Schatz der Geschichte', desc: '800 Aufgaben gelöst.' },
