// game.js — XP, Levels und Medaillen für Grössenwissen. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Grössenlehrling' },
  { xp: 25, key: 'einheitenkenner', name: 'Einheitenkenner' },
  { xp: 90, key: 'referenzprofi', name: 'Referenzprofi' },
  { xp: 220, key: 'groessenmeister', name: 'Grössenmeister' },
  { xp: 500, key: 'groessenweise', name: 'Grössenweise' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erste Einheit', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Grössenwissen-Legende', desc: '55 Runden abgeschlossen.' },
