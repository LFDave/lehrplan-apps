...
export const FR_QA = {
  ...
  begriffQA: [
    ['Was ist ein Würfel?', 'ein Körper', ['eine Figur', 'eine Linie']],
    ['Was ist ein Quadrat?', 'eine Figur', ['ein Körper', 'eine Kante']],
    ['Was ist eine Kugel?', 'ein Körper', ['eine Figur', 'eine Fläche']],
    ['Was ist ein Kreis?', 'eine Figur', ['ein Körper', 'eine Ecke']],
    ...
    ['Was ist ein Dreieck?', 'eine Figur', ['ein Körper', 'eine Kante']],
    ['Was ist ein Rechteck?', 'eine Figur', ['ein Körper', 'eine Linie']],
    ['Ein Ball liegt auf dem Tisch. Was ist der Ball?', 'ein Körper', ['eine Figur', 'eine Fläche']],
    ['Ein Dreieck ist auf ein Blatt gezeichnet. Was ist es?', 'eine Figur', ['ein Körper', 'eine Länge']],
    ['Was kannst du in die Hand nehmen und von allen Seiten anschauen?', 'einen Körper', ['eine Figur', 'eine Fläche']],
    ['Was ist flach und liegt ganz auf dem Blatt?', 'eine Figur', ['ein Körper', 'eine Breite']],
    ['Du schiebst ein Puzzleteil gerade nach rechts, ohne es zu drehen. Wie heisst das?', 'verschieben', ['spiegeln', 'drehen']],
    ['Eine Figur wird gespiegelt. Wie gross ist sie danach?', 'gleich gross', ['grösser', 'kleiner']],
    ['Eine Figur wird verschoben. Was bleibt gleich?', 'ihre Form und Grösse', ['nur ihr Ort', 'nichts']],
    ['Wie lang eine Figur ist, nennt man ihre ...', 'Länge', ['Breite', 'Fläche']],
    ['Ein Rechteck ist 5 Kästchen lang und 2 Kästchen breit. Was ist die 5?', 'die Länge', ['die Breite', 'die Fläche']],
    ['Ein Rechteck ist 5 Kästchen lang und 2 Kästchen breit. Was ist die 2?', 'die Breite', ['die Länge', 'die Fläche']],
    ['Du malst ein Rechteck ganz aus. Was hast du ausgemalt?', 'die Fläche', ['die Länge', 'die Breite']],
  ],
  kreisTerms: [
  ...
  charakterisierenQA: [
    ...
    ['In welchem Viereck sind die Diagonalen gleich lang und schneiden sich rechtwinklig?', 'Quadrat', ['Rechteck', 'Parallelogramm']],
    ['In welchem Viereck sind die Diagonalen gleich lang, schneiden sich aber nicht rechtwinklig?', 'Rechteck', ['Rhombus', 'Drachenviereck']],
    ['In welchem Viereck schneiden sich die Diagonalen rechtwinklig, sind aber nicht gleich lang?', 'Rhombus', ['Rechteck', 'Trapez']],
    ['Welches Dreieck hat drei gleich lange Seiten?', 'gleichseitiges Dreieck', ['gleichschenkliges Dreieck', 'rechtwinkliges Dreieck']],
    ['Welches Dreieck hat genau zwei gleich lange Seiten?', 'gleichschenkliges Dreieck', ['gleichseitiges Dreieck', 'stumpfwinkliges Dreieck']],
    ['Welches Dreieck hat einen Winkel von 90 Grad?', 'rechtwinkliges Dreieck', ['spitzwinkliges Dreieck', 'gleichseitiges Dreieck']],
    ['Welches Dreieck hat einen Winkel, der grösser als 90 Grad ist?', 'stumpfwinkliges Dreieck', ['spitzwinkliges Dreieck', 'rechtwinkliges Dreieck']],
    ['Wie viele Paare paralleler Seiten hat ein Parallelogramm?', '2', ['1', '0']],
  ],
  kongruenzQA: [
