// game.js — XP, Levels und Medaillen für Formenreich. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'lehrling', name: 'Formenspäher' },
  { xp: 25, key: 'eckenzaehler', name: 'Eckenzähler' },
  { xp: 90, key: 'formenkenner', name: 'Formenkenner' },
  { xp: 220, key: 'koerperprofi', name: 'Körperprofi' },
  { xp: 500, key: 'formenmeister', name: 'Formenmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erste Form', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Formenreich-Legende', desc: '55 Runden abgeschlossen.' },
  ...
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Körperschatz', desc: '800 Aufgaben gelöst.' },
  ...
  { key: 'ga-z3', icon: 'target', threshold: (s) => cleanRuns(s, 'k') >= 1, name: 'Grundanspruch Zyklus 3', desc: 'Stufe k ohne Fehler geschafft.' },
