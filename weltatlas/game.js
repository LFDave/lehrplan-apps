// game.js — XP, Levels und Medaillen für Weltatlas. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'starter', name: 'Atlas-Starter' },
  { xp: 25, key: 'finder', name: 'Ortefinder' },
  { xp: 90, key: 'kenner', name: 'Länderkenner' },
  { xp: 220, key: 'profi', name: 'Gradnetz-Profi' },
  { xp: 500, key: 'meister', name: 'Atlas-Meister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erster Ort', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Weltatlas-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Ortsblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Welt-Schatz', desc: '800 Aufgaben gelöst.' },
