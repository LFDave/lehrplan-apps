// game.js — XP, Levels und Medaillen für Bitkiste. Reine Funktionen
...
export const LEVELS = [
  { xp: 0, key: 'ordner', name: 'Aufräumer' },
  { xp: 25, key: 'sammler', name: 'Datensammler' },
  { xp: 90, key: 'codierer', name: 'Codierer' },
  { xp: 220, key: 'strukturierer', name: 'Strukturierer' },
  { xp: 500, key: 'meister', name: 'Datenmeister' },
];
...
export const MEDALS = [
  { key: 'runde-1', icon: 'flag', threshold: (s) => s.rounds >= 1, name: 'Erstes Bit', desc: 'Eine Runde abgeschlossen.' },
  ...
  { key: 'runden-55', icon: 'trophy', threshold: (s) => s.rounds >= 55, name: 'Bitkiste-Legende', desc: '55 Runden abgeschlossen.' },
  { key: 'aufgaben-50', icon: 'pencil', threshold: (s) => s.tasks >= 50, name: 'Fleissige Hände', desc: '50 Aufgaben gelöst.' },
  { key: 'aufgaben-200', icon: 'zap', threshold: (s) => s.tasks >= 200, name: 'Datenblitz', desc: '200 Aufgaben gelöst.' },
  { key: 'aufgaben-800', icon: 'gem', threshold: (s) => s.tasks >= 800, name: 'Datenschatz', desc: '800 Aufgaben gelöst.' },
